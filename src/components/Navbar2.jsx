...
return (
<>
    <div className="w-45 h-70 opacity-90 bg-sky-950">
        <nav className="lg:flex items-center justify-between p-4 bg-sky-950 font-sans">
            ...
            <div className="lg:flex space-x-4 text-md mx-36">
                <div className="self-end">
                    ...
                    <a href="https://edspert.id/pages/all-class-filter/program/4e413d3d" target="_blank"
                        rel="noopener noreferrer" className="text-white hover:text-gray-200 my-auto font-navbar mr-5">
                        Tentang edspert.id
                    </a>
                </div>
                <div
                    className="w-36 h-12 px-6 py-2.5 bg-red-400 rounded-3xl flex-col justify-center items-center gap-2.5 inline-flex">
